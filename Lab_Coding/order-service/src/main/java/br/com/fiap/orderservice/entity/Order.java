...
public class Order {
    ...
    public Order(int id, int idPedido, String email, String nome,
                 String shippingAddress, String descricao,
                 int quantidadeIten, BigDecimal preco, BigDecimal valor,
                 String formaPagamento, LocalDateTime dataPedido, String status,
                 int idTransacao, String numeroCartao, String validade, String bandeira) {
        this.id = id;
